            ...
            <tbody>
                    @foreach ($lettres as $lettre)
                        <tr>
                            <td>{{ $lettre->title }}</td>
                            <td>{{ $lettre->type }}</td>
                            <td>{{ $lettre->sent_at ? $lettre->sent_at->format('d/m/Y') : 'N/A' }}</td>
                            <td>
                                <a href="{{ Storage::url($lettre->file_path) }}" class="btn btn-sm btn-info" target="_blank">Télécharger</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
